...
function getDaylogAPI(date) {
  ...
  if (date === undefined) {
    return axios.get('/daylog').then((res) => {
      //console.log('axios get data', res);
      return res;
    });
  } else {
    return axios.get('/daylog' + date).then((res) => {
      //console.log('axios get data', res);
      return res;
    });
  }
...
function postDaylogAPI(data) {
  ...
  return axios.post('/daylog', sendData).then((res) => {
    console.log('res', res);
...
function filterTagAPI(tagid) {
  ...
  return axios.get('/daylog/tag/' + tagid).then((res) => {
